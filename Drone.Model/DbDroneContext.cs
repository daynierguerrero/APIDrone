...
public partial class DbDroneContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=DESKTOP-HF0C10F\\SQL2017; DataBase=DBDRON1; Trusted_Connection=True; TrustServerCertificate=True; User ID=sa;Password=Versat2022*");
